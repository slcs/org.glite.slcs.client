...
public class CookiesTest extends TestCase {
    ...
    public void testMatch() {
        ...
        boolean secure = true;
        boolean matched = cookieSpecBase.match(host, port, path, secure, cookie);
    ...
    public void testParse() {
        ...
        boolean secure = true;
        try {
            Cookie cookies[] = cookieSpecBase.parse(host,port,path,secure, header);
            for (Cookie cookie : cookies) {
                System.out.println(cookie.getName() + "=" + cookie.getValue() + " domain:" + cookie.getDomain() + " path:" + cookie.getPath() + " secure:" + cookie.getSecure());
